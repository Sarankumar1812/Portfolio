              ...
              <div className="cards__card card">
                ...
                <ul role="list" className="card__bullets flow">
                  ...
                  <li>
                    ...
                    <mark>Round 1</mark> <br />
                    * Participants must submit their Photo within 25/02/2024 <br />
                    * Shortlisted Participants will be notified by next day through their registered e-mail

                  </li>
                  <li>
                    Round 2 <br />
                    * Shorlisted Participants are eligible for 2nd round <br />
                    * 2nd round will be ofline mode, the participants are ask to take photo's inside the campus and they will allowed 30 mins for editing
                  </li>
                  <li>
                    Certificates will be given for winner
                  </li>
                </ul>
                <a
                  href="https://docs.google.com/forms/d/e/1FAIpQLSdKmxqrnh2SI2odNGcbtgP0yij6TFQ6UBzchg8pCfsQZGYZLQ/viewform?usp=sf_link"
